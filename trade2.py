...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.pushButton_3.clicked.connect(self.run_th)  # 자동매수 프로그램
    ...
    def run_th(self):
        sbp1 = mp.Process(name="auto_rub", target=self.auto_run)
    ...
    def auto_run(self):
        ...
        for i, code in enumerate(self.kosdaq_codes):
            ...
            if rising_tf :
                ...
                print("급등주: ", code)
                """"
                th3 = Thread(target=self.update_buy_list, args=(buy_list))
                th3.start()
                th3.join()
                """""
                f = open("buy_list.txt", "a+", encoding='utf-8')
